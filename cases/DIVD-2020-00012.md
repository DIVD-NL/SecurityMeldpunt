...
Indien uw Fortinet device kwetsbaar is, hetstel dan de kwetsbaarheid en ga ervan uit dat de gebruikersnamen en wachtworoden van uw gebruiker gelekt zijn.
De kwetsbaarheid kan verholpen worden door te upgraden naar een niet kwetsbare versie. Voor de eindegbruikers raden we u aan minimaal hun wachtwoorden te resetten. 
...
| Date  | Description |
|:-----:|-------------|
| 24-05-2019 | Fortinet PSIRT publishes advisory for CVE-2019-13379 || 20-11-2020 | Researcher comes across list of vulnerable systems |
